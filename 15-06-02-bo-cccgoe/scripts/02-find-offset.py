...
# commenting out the old buffer for this step
# buffer = 'A' * 2700

# new buffer with pattern created using "/usr/share/metasploit-framework/tools/pattern_create.rb 2700"
# offset can be calculated with "/usr/share/metasploit-framework/tools/pattern_offset.rb CONTENTFROMEIPATCRASHTIME"
# you get the EIP content from immutiny debugger at the time of the crash
# example:
